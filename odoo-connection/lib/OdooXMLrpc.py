...
class OdooXMLrpc:
    ...
    def setUserID(self):
        ...
        try:
            ...
            socket.setdefaulttimeout(float(Utils.settings["timeoutToGetOdooUID"]) or None)
    ...
    def checkAttendance(self, card):
        ...
        try:
            ...
            if serverProxy:
                socket.setdefaulttimeout(float(Utils.settings["timeoutToCheckAttendance"]) or None)
